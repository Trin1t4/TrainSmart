  ...
  const options = [
    {
      ...
      title: t('onboarding.screening.thoroughTitle') || 'Screening Approfondito',
      subtitle: t('onboarding.screening.thoroughSubtitle') || 'Consigliato per programmi personalizzati',
      description: t('onboarding.screening.thoroughDesc') || 'Analisi completa delle tue capacità per un programma su misura',
      details: [
        t('onboarding.screening.questions7') || '7 domande dettagliate',
        t('onboarding.screening.tests4') || '4 test fisici pratici',
        t('onboarding.screening.calibration') || 'Calibrazione precisa del programma',
        t('onboarding.screening.duration15') || 'Durata: ~10-15 minuti'
      ],
      icon: ClipboardCheck,
      color: 'emerald',
      recommended: true
    },
    {
      ...
      title: t('onboarding.screening.lightTitle') || 'Screening Rapido',
      subtitle: t('onboarding.screening.lightSubtitle') || 'Per iniziare subito',
      description: t('onboarding.screening.lightDesc') || 'Valutazione essenziale per partire velocemente',
      details: [
        t('onboarding.screening.questions3') || '3 domande veloci',
        t('onboarding.screening.tests2') || '2 test fisici base',
        t('onboarding.screening.standardProgram') || 'Programma standard adattato',
        t('onboarding.screening.duration5') || 'Durata: ~5 minuti'
      ],
      icon: Zap,
      color: 'blue',
      recommended: false
    ...
    <div className="space-y-6">
      <div className="text-center mb-6">
        <h2 className="text-2xl font-bold text-white mb-2">
          {t('onboarding.screening.title') || 'Scegli il Tipo di Valutazione'}
        </h2>
        <p className="text-slate-400">
          {t('onboarding.screening.subtitle') || 'Quanto vuoi che sia approfondita l\'analisi delle tue capacità?'}
        </p>
      </div>
            ...
            >
              ...
              {option.recommended && (
                <div className="absolute -top-3 left-4 px-3 py-1 bg-emerald-500 text-white text-xs font-semibold rounded-full">
                  {t('common.recommended') || 'Consigliato'}
                </div>
              )}
      ...
      <div className="p-4 bg-slate-700/30 rounded-lg border border-slate-600/50">
        <p className="text-sm text-slate-400 text-center">
          ...
          {t('onboarding.screening.note') || 'Lo screening approfondito permette di creare un programma piu preciso e adatto alle tue capacità reali'}
        </p>
      </div>
