...
export const CORRECTIVE_EXERCISE_DESCRIPTIONS: Record<string, ExerciseDescription> = {
  ...
  'McKenzie Press-ups': {
    description: 'Centralizza il dolore con estensione ripetuta (McKenzie Protocol)',
    technique: [
  ...
  'Prone Cobra': {
    description: 'Rinforza estensori toracici e lombari',
    technique: [
  ...
  'Bird Dog (Anti-flexion)': {
    description: 'Stabilità anti-flessione in posizione neutra',
    technique: [
  ...
  'Cat-Cow (Flexion Emphasis)': {
    description: 'Mobilità flessione + decompressione vertebrale',
    technique: [
  ...
  'Child\'s Pose': {
    description: 'Stretch passivo in flessione, riduce compressione posteriore',
    technique: [
  ...
  'Dead Bug': {
    description: 'Stabilità anti-estensione',
    technique: [
  ...
  'Pallof Press (Anti-rotation)': {
    description: 'Rinforza anti-rotazione, stabilizza colonna',
    technique: [
  ...
  'Side Plank': {
    description: 'Stabilità laterale, previene rotazione eccessiva',
    technique: [
  ...
  'Quadruped Thoracic Rotation': {
    description: 'Mobilità toracica CONTROLLATA, deloading lombare',
    technique: [
  ...
  '90/90 Hip Stretch': {
    description: 'Migliora rotazione interna e riduce impingement anteriore',
    technique: [
  ...
  'Hip Flexor Stretch (Modified)': {
    description: 'Riduce tensione ileo-psoas che peggiora impingement',
    technique: [
  ...
  'Clamshells': {
    description: 'Rinforza rotatori esterni anca',
    technique: [
  ...
  'Pigeon Stretch (Modified)': {
    description: 'Migliora rotazione esterna anca',
    technique: [
  ...
  'Banded Hip Distraction': {
    description: 'Decompressione articolare + mobilità capsulare',
    technique: [
  ...
  'Spanish Squat': {
    description: 'Riduce compressione patello-femorale del 30-40%',
    technique: [
  ...
  'Terminal Knee Extension': {
    description: 'Isola VMO (vasto mediale obliquo), stabilizza rotula',
    technique: [
  ...
  'Clamshells + Lateral Band Walks': {
    description: 'Rinforza abduttori anca, previene valgus dinamico',
    technique: [
  ...
  'Knee Flexion Mobilization': {
    description: 'Migliora ROM flessione riducendo dolore',
    technique: [
  ...
  'Wall Sit Isometric': {
    description: 'Rinforza in range confortevole, nessun movimento',
    technique: [
  ...
  'Face Pulls': {
    description: 'Rinforza rotatori esterni + retrazione scapolare',
    technique: [
  ...
  'Wall Slides': {
    description: 'Mobilità overhead con controllo scapolare',
    technique: [
  ...
  'YTW Raises': {
    description: 'Rinforza stabilizzatori scapola in pattern funzionali',
    technique: [
  ...
  'External Rotation (Side-lying)': {
    description: 'Isolamento rotatori esterni della cuffia',
    technique: [
  ...
  'Scapular Push-ups': {
    description: 'Attiva e rinforza serratus anterior',
    technique: [
  ...
  'Chin Tucks': {
    description: 'Rinforza flessori cervicali profondi, migliora postura Forward Head',
    technique: [
  ...
  'Prone Neck Extension': {
    description: 'Rinforza estensori cervicali',
    technique: [
  ...
  'Cervical Flexion Stretch': {
    description: 'Stretch posteriore collo, riduce tensione estensori',
    technique: [
  ...
  'Deep Neck Flexor Strengthening': {
    description: 'Contrasta weak deep flexors che causano extension pain',
    technique: [
      'Supino, chin tuck',
  ...
  'Cervical Rotation Stretch': {
    description: 'Migliora ROM rotazione',
    technique: [
  ...
  'Isometric Rotation Holds': {
    description: 'Rinforza rotatori in posizione neutra',
    technique: [
      'Mano contro tempia',
  ...
  'Cervical Traction (Self)': {
    description: 'Decomprime radici nervose',
    technique: [
  ...
  'Nerve Glide - Median': {
    description: 'Mobilizza nervo mediano se sintomi braccio',
    technique: [
  ...
  'Eccentric Wrist Extension': {
    description: 'Gold standard per lateral epicondylitis (Tyler Twist)',
    technique: [
  ...
  'Forearm Extensor Stretch': {
    description: 'Riduce tensione extensors',
    technique: [
  ...
  'Wrist Radial Deviation with Theraband': {
    description: 'Rinforza ECRL/ECRB (specifici per tennis elbow)',
    technique: [
  ...
  'Eccentric Wrist Flexion': {
    description: 'Gold standard per medial epicondylitis',
    technique: [
  ...
  'Forearm Flexor Stretch': {
    description: 'Riduce tensione flexors',
    technique: [
  ...
  'Elbow Flexion Mobilization': {
    description: 'Migliora ROM flessione',
    technique: [
  ...
  'Elbow Extension Stretch': {
    description: 'Migliora ROM estensione',
    technique: [
  ...
  'Median Nerve Glide': {
    description: 'Se Phalen\'s positivo (carpal tunnel)',
    technique: [
  ...
  'Wrist Flexor Strengthening': {
    description: 'Rinforza flexors se weak',
    technique: [
  ...
  'Wrist Extension Strengthening': {
    description: 'Rinforza extensors',
    technique: [
  ...
  'Radial/Ulnar Deviation Mobilization': {
    description: 'Migliora ROM deviazione',
    technique: [
  ...
  'Wall Slides with Protraction': {
    description: 'Insegna scapular upward rotation corretta',
    technique: [
      'Schiena al muro, braccia a W',
  ...
  'Prone Y Raises': {
    description: 'Rinforza lower trap e romboidi',
    technique: [
  ...
  'Band Pull-Aparts': {
    description: 'Rinforza retractors',
    technique: [
  ...
  'Scapular CARs (Controlled Articular Rotations)': {
    description: 'Migliora coordinazione scapulo-omerale',
    technique: [
  ...
  'Open Book Stretch': {
    description: 'Mobilità rotazione + apertura torace',
    technique: [
      'Decubito laterale, ginocchia piegate',
  ...
  'Foam Roll Thoracic Extension': {
    description: 'Mobilità estensione toracica (kyphosis correction)',
    technique: [
  ...
  'Cat Stretch (Thoracic Focus)': {
    description: 'Mobilità flessione toracica',
    technique: [
      'Quadrupedia',
  ...
  'Wall Ankle Mobilization': {
    description: 'Gold standard per migliorare dorsiflexion ROM',
    technique: [
  ...
  'Ankle Dorsiflexion with Band': {
    description: 'Mobilizza joint capsule anteriore',
    technique: [
  ...
  'Tibialis Anterior Strengthening': {
    description: 'Rinforza dorsiflexors',
    technique: [
  ...
  'Calf Stretch (Gastrocnemius)': {
    description: 'Stretch calf se limited plantarflexion',
    technique: [
  ...
  'Calf Raises': {
    description: 'Rinforza plantarflexors',
    technique: [
  ...
  'Single Leg Balance Progression': {
    description: 'Migliora propriocezione e stability dopo sprain',
    technique: [
      'Stand on one leg',
  ...
  'Ankle Alphabets': {
    description: 'Mobilità multi-planare + propriocezione',
    technique: [
  ...
  'Lateral Band Walks': {
    description: 'Rinforza evertors/invertors + hip abductors',
    technique: [
  ...
  'Controlled Inversion/Eversion': {
    description: 'Rinforza stabilizzatori dopo sprain',
    technique: [
  ...
  'Bosu Ball Balance': {
    description: 'Riabilita propriocezione post-sprain',
    technique: [
