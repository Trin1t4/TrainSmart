/**
 * CENTRALIZED LEVEL CALCULATION - DCSS Revision
 *
 * Single source of truth for user level determination.
 * 
 * CHANGE LOG (DCSS Revision):
 * - REMOVED: Machines mode forcing beginner
 * - ADDED: machinePreference flag instead of level override
 * - Rationale: Advanced users choosing machines (rehab, preference) 
 *   should not be downgraded. The system should respect their choice.
 *
